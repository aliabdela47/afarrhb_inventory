        ...
        <form method="POST" action="{{ route('items.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name_am" id="name_am" value="{{ old('name_am') }}"
                ...
                <div>
                    ...
                    <input type="text" name="unit_of_measure" id="unit_of_measure" value="{{ old('unit_of_measure') }}" 
                           placeholder="{{ app()->getLocale() === 'am' ? 'ምሳሌ: ኪ.ግ፣ ሳጥን፣ ቁራጭ' : 'e.g., kg, box, pcs' }}" required
                ...
                <div>
                    ...
                    <input type="number" name="unit_price" id="unit_price" step="0.01" min="0" value="{{ old('unit_price') }}" required
                ...
                <div>
                    ...
                    <input type="number" name="reorder_level" id="reorder_level" min="0" value="{{ old('reorder_level', 10) }}" required
